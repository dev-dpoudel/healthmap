...
class HospitalFilters(filters.FilterSet):
    name = filters.CharFilter(field_name="name", lookup_expr="icontiains")
...
class BedInfoFilters(filters.FilterSet):
    active = filters.BooleanFilter(field_name="is_active")
    occupied = filters.BooleanFilter(field_name="is_occupied")
    fromdate = filters.DateFilter(field_name="planned_service_date", lookup_expr="year__gte")  # noqa E501
    tilldate = filters.DateFilter(field_name="planned_service_date", lookup_expr="year__lte")  # noqa E501
