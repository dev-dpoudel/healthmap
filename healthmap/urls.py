...
router.register(r'diagnosis', caseView.DiagnosisViewSet)
router.register(r'investigation', caseView.InvestigationHistoryViewSet)
router.register(r'medication', caseView.MedicationViewSet)
router.register(r'medicalStaff', moView.MOViewSet)
router.register(r'staff', staffView.StaffPersonViewSet)
router.register(r'staff-family', staffView.StaffFamilyViewSet)
router.register(r'refer', referView.ReferralViewSet)
router.register(r'hospital', hospitalView.HospitalViewSet)
router.register(r'department', hospitalView.DepartmentViewSet)
router.register(r'rooms', hospitalView.RoomInfoViewSet)
